      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <button onClick={onBack}
            style={{ background: 'none', border: '1px solid #E5E7EB', borderRadius: 8, padding: '6px 12px', cursor: 'pointer', fontSize: 13, color: '#6B7280', display: 'flex', alignItems: 'center', gap: 4 }}>
            ← Back
          </button>
          {renaming ? (
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button 
            ...
            style={{ background: '#E6F4F1', border: '1px solid #004D40', borderRadius: 8, padding: '6px 14px', cursor: 'pointer', fontSize: 13, color: '#004D40', fontWeight: 600 }}>
            ❓ Edit Questions
          </button>
              ...
              {cards.map((card, i) => (
                <div key={card.id} style={{ background: 'white', border: '1px solid #E5E7EB', borderRadius: 12, overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
                  <div style={{ padding: '12px 16px', background: '#F0FDF4', borderBottom: '1px solid #D1FAE5', fontSize: 13, fontWeight: 700, color: '#065F46', display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{ background: '#004D40', color: '#fff', borderRadius: '50%', width: 22, height: 22, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, fontWeight: 700 }}>
                      {i + 1}
                    </span>
                    {card.front}
                  </div>
