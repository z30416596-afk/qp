    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        <div style={{
          ...
          {/* Info panel toggle — PROMINENT */}
          <button
            onClick={() => setInfoPanelOpen((v) => !v)}
            title={infoPanelOpen ? "Hide profile panel" : "Show profile panel"}
            style={{
              background: infoPanelOpen ? "#E6F4F1" : "#FEF3C7",
              border: infoPanelOpen ? "2px solid #004D40" : "2px solid #F59E0B", 
              borderRadius: 8,
              padding: "6px 10px", cursor: "pointer", color: infoPanelOpen ? "#004D40" : "#92400E",
              fontSize: 12, fontWeight: 700,
              display: "flex", alignItems: "center", gap: 5, flexShrink: 0,
              boxShadow: infoPanelOpen ? "0 2px 8px rgba(0,77,64,0.15)" : "0 2px 8px rgba(245,158,11,0.15)",
              transition: "all 0.15s",
            }}
          >
            <i className={`ti ${infoPanelOpen ? "ti-layout-sidebar-right-collapse" : "ti-layout-sidebar-right-expand"}`} style={{ fontSize: 14 }} />
            <span>{infoPanelOpen ? "Profile" : "Show"}</span>
          </button>
        </div>
        ...
        <div style={{
          ...
          background: "white", flexShrink: 0, position: "sticky", bottom: 0, zIndex: 10,
        }}>
          {limitReached && (
            <div style={{
      ...
      {/* ── Right: Info panel — scrollable independently ── */}
      {infoPanelOpen && (
